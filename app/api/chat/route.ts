    ...
    execute: async ({ writer }) => {
      ...
      writer.write({
        ...
        data: {
          ...
          name: "model-call",
          status: "running",
          detail: `${resolvedProvider}/${modelResult.resolvedModel} で議事録と質問を読み込み、一次回答案を作成しています。${
      ...
      writer.write({
        ...
        data: {
          ...
          status: "running",
          detail: "回答案を3視点（Observer / Skeptic / Operator）で並列点検しています。",
          timestamp: new Date().toISOString(),
        },
        transient: true,
      });
      ...
      writer.write({
        ...
        data: {
          ...
          name: "final-answer",
          status: "running",
          detail: "点検済みの最終回答をチャット本文へ反映しています。",
          timestamp: new Date().toISOString(),
        },
        transient: true,
      });
